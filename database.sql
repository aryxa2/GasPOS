-- --------------------------------------------------------
-- GasPOS Database Schema & Seed Data
-- --------------------------------------------------------
...
-- 2. Tabel Pengguna (Manajemen Kasir & Admin)
...
-- 3. Tabel Produk (Manajemen Produk & Inventori)
...
-- 4. Tabel Transaksi (Header Transaksi Penjualan)
...
-- 5. Tabel Transaksi Detail (Rincian Item yang Terjual)
